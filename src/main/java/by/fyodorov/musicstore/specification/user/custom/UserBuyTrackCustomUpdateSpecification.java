...
public class UserBuyTrackCustomUpdateSpecification implements UserCustomUpdateSpecification {
    ...
    public UserBuyTrackCustomUpdateSpecification(String userName, String trackName) {
