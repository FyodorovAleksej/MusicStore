...
public class UserInsertTracksFromAssemblageCustomSelect implements UserCustomSelectSpecification {
    ...
    public UserInsertTracksFromAssemblageCustomSelect(String userName, String assemblageName) {
