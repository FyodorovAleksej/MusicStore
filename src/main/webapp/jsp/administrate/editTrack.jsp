...
<fmt:message key="add.trackEditSendLabel" var="trackEditSendLabel"/>
...
<form action="/editTrack" method="post">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text-left" id="name" style="margin-left: 10px; margin-bottom: 2px;"
                       name="trackName" value="${trackOldName}">
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="number" min="0" class="text-left" id="price" name="trackPrice" value="${trackOldPrice}"
            ...
            <td>
                <select id="performer" name="trackPerformer">
                    <c:forEach items="${performersList}" var="performerEntity">
                        <option value="${performerEntity}" ${performerEntity == trackOldPerformer ? 'selected' : ''}>
    ...
    <button type="submit" class="btn btn-primary" style="background-color: rgba(0,230,0,0.8); margin-top: 5px"><c:out
            value="${trackEditSendLabel}"/></button>
</form>
<!-- Bootstrap -->
