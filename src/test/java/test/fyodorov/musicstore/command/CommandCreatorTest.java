...
public class CommandCreatorTest {
    ...
    private final static String LOGIN_COMMAND_NAME = CommandEnum.LOGIN_COMMAND.toString();
    private final static String LOWER_LOGIN_COMMAND_NAME = CommandEnum.LOGIN_COMMAND.toString().toLowerCase();
    ...
    public void testCreateCommandPositive() throws Exception {
        ...
        Assert.assertEquals(command, CommandEnum.LOGIN_COMMAND.getCommand());
    }
    ...
    public void testCreateCommandNull() throws Exception {
        ...
        Assert.assertEquals(command, CommandEnum.getDefault().getCommand());
    }
}